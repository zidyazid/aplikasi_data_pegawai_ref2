              ...
              <div class="col-xl-12">
                  ...
                  <div class="card bg-default shadow">
                      <div class="card-header bg-transparent border-0">
                          ...
                          <div class="row">
                              <div class="col-lg-2">
                                  <a href="<?= base_url('Admincontroller/laporanPegawaiPdf') ?>" class="btn btn-white mt-3"><i class="text-danger fas fa-file-pdf mr-2"></i>Export to pdf</a>
                              </div>
                              <div class="col-lg-2">
                          ...
                          <table class="table align-items-center table-dark table-flush">
                              <thead class="thead-dark">
                                  <tr>
                                      ...
                                      <th scope="col" class="sort" data-sort="name">Id Jabatan</th>
                                  ...
                                  <?php foreach ($getAllPegawai as $p) : ?>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="<?= base_url('admincontroller/deleteDataPegawai/' . $p['id']) ?>" class="btn-sm btn btn-danger"> <i class="fas fa-trash-alt"></i> Hapus</a>
                                          </td>
                                      </tr>
                                      <?php $i++; ?>
                                  <?php endforeach; ?>
